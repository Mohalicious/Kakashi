...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.fkontak = global.contact
        global.doc = pickRandom(["application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "application/msword", "application/pdf"])
        global.img = 'https://i.imgur.com/4rRZ4c7.jpeg'
        ...
        global.time = require('moment-timezone').tz('Africa/Nairobi').format('HH:mm:ss')
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            let wel = API('lol', '/api/base/leave', {
                                img1: pp1,
  ...
  contextInfo: {mentionedJid: [user],
    ...
    async groupsUpdate(groupsUpdate, fromMe, m) {
        ...
        for (let groupUpdate of groupsUpdate) {
            ...
            //console.log('=============\n\ngroupsUpdate \n\n============\n\n' + await groupUpdate)
            if (!text) continue
            await this.sendButton(id, text, wm, 'Turn Off Features', `.off detect`, global.ftroli, { contextInfo: { mentionedJid: this.parseMention(text) }, mentions: await this.parseMention(text) })
...
global.dfail = async (type, m, conn) => {
    ...
    let msg = {
        rowner: 'Ts F Is O F O',
        owner: 'Ts F Is O F O',
        mods: 'This command can only be used by *Moderators*',
        premium: 'This command is only for _*Premium*_ members!',
        group: 'F Us O F Gs!',
        private: 'Fs Us O F P C!',
        admin: 'Ts F Is O F A!',
        botAdmin: 'B Ms B A Fs!',
        unreg: 'Please register to use this feature by typing:\n\n*#register of names.age*\n\nExample: *#register of turboxajmal.18*',
        nsfw: 'NSFW is not active, Please contact the owner to activate this feature!',
        rpg: 'RPG is not active, please contact owner to activate this feature!',
...
global.thumb = 'https://i.imgur.com/4rRZ4c7.jpeg'
